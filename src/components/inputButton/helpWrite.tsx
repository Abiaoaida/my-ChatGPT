...
//引入全网搜索的图标
import OnlineSearch from '../../static-assets/online-search.svg'
//引入文档编辑器图标
import WriteBook from '../../static-assets/wendangbianji.svg'
//引入语音输入图标
    ...
    >
      <div style={{ display: 'flex' }}>
        ...
        <Button
          ...
          icon={<OnlineSearch className='arco-icon arco-icon-custom' />}
        >
          全网搜索
        </Button>
        {/* 文档编辑 */}
        <Button
          ...
          icon={<WriteBook className='arco-icon arco-icon-custom' />}
        >
          文档编辑器
        </Button>
      </div>
