...
//引入link图标
import Link from '../../static-assets/link.svg' //引入语音输入图标
    ...
    >
      <div style={{ display: 'flex' }}>
        ...
        <Button
          id='aiclould'
          type='outline'
          style={{ borderRadius: '10px', borderColor: '#ddd', color: 'black' }}
          icon={<AiCloud className='arco-icon arco-icon-custom' />}
        >
          AI云盘
        </Button>
      </div>
